// src/components/jobs/JobsFAQSection.jsx
import { useState } from "react";
import { motion, AnimatePresence } from "framer-motion";
import { HiChevronDown } from "react-icons/hi";
import { Link } from "react-router-dom";
import { JOBS_FAQS } from "../../data/jobsFaqs";

/**
 * FAQ section for Jobs page.
 * Left: Heading + Subtext + Link.
 * Right: Accordion.
 */
const JobsFAQSection = () => {
  ...
  return (
    <section className="py-10 sm:py-16 bg-gold-50 border-t border-gold-200/50">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_2fr] gap-12 lg:gap-16 items-start">
          ...
          <div className="flex flex-col gap-4 sticky top-24">
            ...
            <p className="text-navy-500 text-base leading-relaxed mb-2">
              Quick answers to common questions about finding and posting jobs on Newcomer Jobline.
            </p>
            <Link
              to="/contact"
              className="font-bold text-teal-700 hover:text-teal-800 transition-colors text-sm flex items-center gap-1 w-fit"
            >
